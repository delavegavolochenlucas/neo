...
def encerrar_sessao(estado):
    print("\nAgente: O que você estudou ou fez de produtivo nessa sessão? (deixe em branco para pular)")
    try:
    ...
    if estudado:
        ...
        print("Agente: Registrado. Consistência é tudo. Até a próxima.")
    else:
        print("Agente: Ok. Até a próxima.")
